    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int i) {
        ...
        holder.parentLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(mContext, DeskripsiActivity.class);
        ...
        holder.btnFavorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.d(TAG,"onClick: clicked on: "+ namaGambar.get(i));
                Toast.makeText(mContext, "Tambahkan" +namaGambar.get(i),Toast.LENGTH_SHORT).show();
            }
        });
        holder.btnShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.d(TAG,"onClick: clicked on: "+ namaGambar.get(i));
                Toast.makeText(mContext, "Whislist" + namaGambar.get(i),Toast.LENGTH_SHORT).show();
            }
        });
